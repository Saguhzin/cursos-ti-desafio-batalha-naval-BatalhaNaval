...
void navios(int matriz[][10]){ //FUNCAO PARA CRIAR NAVIOS, FUNCAO RECEBE MATRIZ (PS É NECESSARIO COLOCAR O TAMANHO DE [][Y] NO PARAMETRO.
  ...
  int navio1[3] = {3, 3, 3}; //VETOR NAVIO 1
    int n1x = 2, n1y = 2; //Cordenadas em x e y;
  ...
  int navio4[3] = {3, 3, 3}; //VETOR NAVIO 4
   ...
   //  ======================================
    ...
    for (int i = 0; i < 3; i++){ //Percorrer o tamanho do navio e usar as cordenadas dadas anteriormente
         ...
         if (((n1x) < 10) && ((n1y + i) < 10) && ((n1x) > 0) && ((n1y + i) > 0))
    ...
    for (int i = 0; i < 3; i++){
         ...
         if (((n2x + i) < 10) && ((n2y) < 10) && ((n2x + i) > 0) && ((n2y) > 0)) //So pinta o navio caso n passe o tamanho da matriz 
    ...
    for (int i = 0; i < 3; i++){ 
          ...
          if (((n3x + i) < 10) && ((n3y + i) < 10) && ((n3x + i) > 0) && ((n3y + i) > 0))
     ...
     for (int i = 0; i < 3; i++){
        ...
        if (((n4x + i) < 10) && ((n4y - i) < 10) && ((n4x + i) > 0) && ((n4y - i) > 0))
